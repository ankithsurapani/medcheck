...
| Manufacturer resolution is **partial** | 1,856 companies from 5,107 published spellings, but 170 ambiguous pairs were left unmerged pending human review. Some companies still appear under more than one `manufacturer_id`. Concentration measured from this file is a **lower bound**. |
