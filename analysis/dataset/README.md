...
- Generated: 2026-08-06 by `analysis/export_dataset.py`
...
| `alert_section` | `nsq_records.alert_section` | central_lab | state_lab | spurious. UNRELIABLE — 13 laboratories appear under both labels across 3,537 records. Informative, not authoritative. |
