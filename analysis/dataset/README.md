...
- **1,727 resolved manufacturers**
- Licence: **CC0 1.0** — public domain, no attribution required (see `LICENSE`)
- Generated: 2026-08-09 by `analysis/export_dataset.py`
...
| Manufacturer resolution is **partial** | 1,727 companies from 5,107 published spellings, but 1 ambiguous pairs were left unmerged pending human review. Some companies still appear under more than one `manufacturer_id`. Concentration measured from this file is a **lower bound**. |
